...
ip6tables -A OUTPUT -t mangle -p icmpv6 -j ACCEPT
ip6tables -A OUTPUT -t mangle -p udp --destination-port 9999  -j ACCEPT
ip6tables -A OUTPUT -t mangle -p udp --destination-port 654  -j ACCEPT
ip6tables -A OUTPUT -t mangle -p udp --destination-port 910  -j ACCEPT
...
ip6tables -A FORWARD -t mangle -p icmpv6 -j ACCEPT
ip6tables -A FORWARD -t mangle -p udp --destination-port 9999 -j ACCEPT
ip6tables -A FORWARD -t mangle -p udp --destination-port 654 -j ACCEPT
ip6tables -A FORWARD -t mangle -p udp --destination-port 910 -j ACCEPT
...
ip6tables -A INPUT -t mangle -p icmpv6 -j ACCEPT
ip6tables -A INPUT -t mangle -p udp --destination-port 0 -j ACCEPT
ip6tables -A INPUT -t mangle -p udp --destination-port 9999 -j ACCEPT
ip6tables -A INPUT -t mangle -p udp --destination-port 654 -j ACCEPT
ip6tables -A INPUT -t mangle -p udp --destination-port 910 -j ACCEPT
